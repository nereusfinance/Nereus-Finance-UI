...
export default function AmountField({
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames('AmountField__wrapper', {
          AmountField__wrapper__focus: onFocus,
        })}
      >
        {!imgSrc ? (
          <TokenIcon tokenSymbol={symbol} width={24} height={24} />
        ) : doubleIcon ? (
          <div className="iconsContent">
            <img src={imgSrc} alt="" width={16.5} height={16.5} className="mainIcon" />
            <img src={imgSrcSecond} alt="" width={16.5} height={16.5} />
          </div>
        ) : (
          <img className="UserIcon" alt="" src={imgSrc} />
        )}
      ...
      <style jsx={true} global={true}>{`
        .AmountField {
          .AmountField__wrapper {
            ...
            &__focus {
              border: 1px solid ${currentTheme.maxWhite.hex};
            }
          }
          &:hover,
          &__focus,
