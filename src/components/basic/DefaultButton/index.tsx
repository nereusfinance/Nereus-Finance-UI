    ...
    <>
      ...
      <style jsx={true} global={true}>{`
        ...
        .DefaultButton {
          ...
          &__primary {
            background: ${currentTheme.textDescr.hex};
            border-color: ${currentTheme.textDescr.hex};
          }
          &__secondary {
          ...
          &__btnGrey {
            ...
            border-color: ${currentTheme.btnGrey.hex};
          }
          &__dark {
          ...
          &__nereusYellow {
            background: ${currentTheme.nereusYellow.hex} !important;
          ...
          &:disabled {
            background: ${currentTheme.disabledButtonBackground.hex} !important;
            border-color: ${currentTheme.disabledButtonBorder.hex} !important;
        ...
        .DefaultButton__onDarkBackground {
          &:disabled {
            background: ${currentTheme.disabledButtonBackground.hex} !important;
            border: 1px ${currentTheme.disabledButtonBorder.hex} solid !important;
            color: ${disabledColor} !important;
          }
        }
      `}</style>
