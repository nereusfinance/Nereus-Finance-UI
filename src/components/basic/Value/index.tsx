...
interface ValueProps {
  ...
  imgSrcSecond?: any;
  doubleIcon?: boolean;
  dollarSignWithoutSpace?: boolean;
}
  ...
  return (
    <div
      className={classNames('Value', `Value__${color}`, className, {
        ...
        Value__onAlignItemsLeft: alignItemsLeft,
      })}
    >
