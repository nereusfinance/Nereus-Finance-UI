...
export function usePayments(): Payments {
  ...
  const transakAvailableAssets = ['ETH', 'USDT', 'DAI', 'USDC', 'UNI', 'LINK', 'WXT', 'MANA'];
  const polygonTransakAvailableAssets = ['MATIC', 'USDT', 'DAI', 'USDC', 'WXT', 'WBTC', 'WETH'];

  const payments: Payment[] = [
    {
      name: PaymentName.nash,
      logo: logos.nashLogo,
      availableAssets: ['USDC', 'WXT', 'ETH'],
