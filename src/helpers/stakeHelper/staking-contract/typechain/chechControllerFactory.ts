...
export class IChefController__factory {
...
const _abi = [
  {
    inputs: [
      { internalType: 'uint128[]', name: '_startTimeOffset', type: 'uint128[]' },
      { internalType: 'uint128[]', name: '_rewardsPerSecond', type: 'uint128[]' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_maxMintable', type: 'uint256' }],
    name: 'setMaxMintable',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
