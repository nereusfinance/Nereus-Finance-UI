...
export const decimalsToCurrencyUnits = (value: string, decimals: number): string =>
  new BigNumberJs(value).shiftedBy(decimals * -1).toFixed();
...
export const augustusToAmountOffsetFromCalldata = (calldata: string): number => {
