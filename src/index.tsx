...
import { WXTPriceDataProvider } from './libs/wxt-price-data-provider';
import { StakeLockDataContextProvider } from './modules/manageWXT/back/StakeLockDataContext';
import { StakeLPDataContextProvider } from './libs/StakeLPContext';
import { NereusIncentiveDataProvider } from './libs/nereus-incentive-data-provider';
import { RewardsProvider } from './libs/rewards-provider';
...
const Router = ({ children }: React.PropsWithChildren<{}>) =>
  IPFS_MODE ? <BrowserRouter>{children}</BrowserRouter> : <HashRouter>{children}</HashRouter>;
                            ...
                            <WalletBalanceProvider>
                              <StaticPoolDataProviderWrapper>
                                <DynamicPoolDataProvider>
                                  ...
                                  <TxBuilderProvider>
                                    <WXTPriceDataProvider>
                                      <StakeLockDataContextProvider>
                                        <NereusIncentiveDataProvider>
                                          <RewardsProvider>
                                            <StakeLPDataContextProvider>
                                              <App />
                                            </StakeLPDataContextProvider>
                                          </RewardsProvider>
                                        </NereusIncentiveDataProvider>
