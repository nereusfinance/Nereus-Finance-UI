    ...
    >
      <Row title={intl.formatMessage(messages.rowTitle)} withMargin={true}>
        <Value
          ...
          subSymbol="USD"
          maximumValueDecimals={isAssetStable(currencySymbol) ? 2 : 6}
      ...
      >
        <Value
          ...
          maximumSubValueDecimals={4}
          tokenIcon={true}
          maximumValueDecimals={isNotHaveEnoughFunds ? 18 : isAssetStable(currencySymbol) ? 2 : 6}
          updateCondition={isTxExecuted}
      ...
      <HealthFactor
        value={
          Math.abs(Number(healthFactorAfterRepay.toString())) > 90534801126826320
            ? '-1'
            : healthFactorAfterRepay.toString()
        }
