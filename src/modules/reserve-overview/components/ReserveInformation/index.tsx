...
export default function ReserveInformation({
  ...
  const aincentivesAPR = marketsAPR[poolReserve.id]?.deposit || '0';
  const vincentivesAPR = marketsAPR[poolReserve.id]?.borrow || '0';

  return (
    <div className="ReserveInformation">
      <div className="ReserveInformation__inner">
        <ContentWrapper className="ReserveInformation__contentTitle Caption">
          <h3 style={{ height: '9px' }} className="ReserveInformation__title">
        ...
        <ContentWrapper className="ReserveInformation__content">
          ...
          <div className="ReserveInformation__APY-info">
            <APYCard title={intl.formatMessage(defaultMessages.deposit)}>
              ...
              <div className="depositAPR">
                <div>{intl.formatMessage(messages.depositAPR)}</div>

                <LiquidityMiningCard
                  value={reserveOverviewData.supplyAPR}
                  liquidityMiningValue={aincentivesAPR}
                  className="depositAPR__Precent"
                />
              </div>
            </APYCard>
            <APYCard title={intl.formatMessage(messages.variableBorrowing)}>
              ...
              />
              <div className="depositAPR">
                <div>{intl.formatMessage(messages.borrowAPR)}</div>
      ...
      <style jsx={true}>{`
        .ReserveInformation {
          ...
          &__contentTitle {
            border-bottom: 1px ${currentTheme.maxBlack.hex} solid;
          }
          &__line {
            color: ${currentTheme.textDarkBlue.hex};
          }
