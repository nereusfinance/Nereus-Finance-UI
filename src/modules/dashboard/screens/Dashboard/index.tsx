...
import DashboardEarnRewardsPanel from '../../components/DashboardEarnRewardsPanel';
          ...
          buttonComponent={
            ...
            >
              {user && user.totalLiquidityUSD !== '0' ? (
                <Value
                  value={Number(user.totalLiquidityUSD).toFixed(2)}
                  symbol="USD"
                  tokenIcon={true}
        ...
        <>
          {!!depositedPositions.length ? (
            ...
            <div className="NoDataPanelWrapper">
              <NoDataPanel
                title={intl.formatMessage(messages.noDepositsTitle)}
                description={intl.formatMessage(messages.noDepositsDescription)}
                withDepositButton={true}
              />
            </div>
          )}
        </>
